...
Route::group(['middleware' => ['Role', 'auth', 'checkSchoolStatus', 'status']], static function () {
    Route::group(['middleware' => 'language'], static function () {
        ...
        Route::group(['prefix' => 'students'], static function () {
            ...
            Route::get('byclass/{classId}', [StudentController::class, 'getStudentsByClass'])->name('students.by.class');
        ...
        Route::group(['prefix' => 'fees'], static function () {
            ...
            Route::get('/statement/{student}', [FeesController::class, 'studentStatement'])->name('fees.statement');
            Route::get('/statement/{student}/pdf', [FeesController::class, 'studentStatementPdf'])->name('fees.statement.pdf');
            
            Route::get('/dashboard/data', [FeesController::class, 'dashboardData'])->name('fees.dashboard.data');
            ...
            Route::get('/invoice/{invoice}', [FeesController::class, 'viewInvoice'])->name('fees.invoice');
            Route::get('/generate/invoice/annual', [FeesController::class, 'generateInvoice'])->name('fees.invoice.generate'); 
            Route::get('/invoice/fee-structures', [FeesController::class,'getFeeStructures'])->name('fees.invoice.fee.structures');
            Route::post('/invoice/generate', [FeesController::class, 'storeGeneratedInvoice'])->name('fees.invoice.generate.store');
            Route::post('/invoice/preview', [FeesController::class, 'previewInvoice'])->name('fees.invoice.preview');

            Route::get('/student/search/index',[FeesController::class,'searchStudentForManualPaymentIndex'])->name('fees.paid.receive.search.index');
            Route::get('/student/search',[FeesController::class,'searchStudentForManualPayment'])->name('fees.paid.receive.search');
            Route::get('/payments/{student}/receive',[FeesController::class,'receivePaymentManual'])->name('fees.paid.receive.payment.manual');
            Route::post('/payments/receive/store',[FeesController::class,'storeManualPayment'])->name('fees.paid.receive.payment.manual.store');
