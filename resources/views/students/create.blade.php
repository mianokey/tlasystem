                        ...
                        <form class="pt-3 student-registration-form" id="create-form" data-success-function="formSuccessFunction" enctype="multipart/form-data" action="{{ route('students.store') }}" method="POST" novalidate="novalidate">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                                 ...
                                 <div class="form-group col-sm-12 col-md-4 col-lg-6 col-xl-3">
                                    <label for="school_transport">
                                        {{ __('School Transport') }}
                                        <span class="text-danger">*</span>
                                    </label>

                                    <select name="school_transport" id="school_transport" class="form-control select2" required>
                                        <option value="van_a" {{ old('school_transport') == 'van_a' ? 'selected' : '' }}>
                                            {{ __('Uses School Van - Zone A') }}
                                        </option>

                                        <option value="van_b" {{ old('school_transport') == 'van_b' ? 'selected' : '' }}>
                                            {{ __('Uses School Van - Zone B') }}
                                        </option>

                                        <option value="no" {{ old('school_transport', 'no') == 'no' ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    {!! Form::textarea('current_address', null, ['required', 'placeholder' => __('current_address'), 'class' => 'form-control', 'rows' => 1]) !!}
                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                    <label>{{ __('permanent_address') }} <span class="text-danger">*</span></label>
                                    {!! Form::textarea('permanent_address', null, ['required', 'placeholder' => __('permanent_address'), 'class' => 'form-control', 'rows' => 1]) !!}
                                </div>
