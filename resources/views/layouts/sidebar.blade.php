            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="fees-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @endcan
                        {{-- @can('generate-fees-invoice') --}}
                            <li class="nav-item">
                                <a href="{{ route('fees.invoice.generate') }}" class="nav-link" data-access="@hasFeatureAccess('Fees Management')"> {{ __('Generate Invoice') }}
                                </a>
                            </li>
                        {{-- @endcan --}}
                         @can('fees-paid')
                            <li class="nav-item">
                                <a href="{{ route('fees.paid.receive.search.index') }}" class="nav-link" data-access="@hasFeatureAccess('Fees Management')"> {{ __('Receive Payment') }}
                                </a>
                            </li>
                        @endcan
